...
from main.execution_node_views import (
    ...
    ExecutionNodeAssignByIdAPIView,
    ExecutionNodeDetailAPIView,
    ExecutionNodeHealthAPIView,
    ExecutionNodeListAPIView,
    ExecutionNodeReleaseAPIView,
    ExecutionNodeReleaseByIdAPIView,
    ExecutionNodeTestBrokerLoginAPIView,
    ExecutionNodeVerifyBrokerAPIView,
    ExecutionNodeVerifyProxyAPIView,
...
urlpatterns = [
    ...
    path('orders/filter-options/', OrdersFilterOptionsView.as_view(), name='orders-filter-options'),
    ...
    path('execution-nodes/<int:node_id>/release/', ExecutionNodeReleaseByIdAPIView.as_view(), name='execution-node-release-by-id'),
    path('execution-nodes/<int:node_id>/verify-proxy/', ExecutionNodeVerifyProxyAPIView.as_view(), name='execution-node-verify-proxy'),
    path('execution-nodes/<int:node_id>/verify-broker/', ExecutionNodeVerifyBrokerAPIView.as_view(), name='execution-node-verify-broker'),
