...
BROKER_SETUP_SPECS = {
    ...
    "groww": {
        ...
        "description": "Save the Groww API auth token from an active Groww Trading API subscription.",
        "save_action_label": "Save Groww API Details",
        "connect_action_label": "Save Groww Token",
        "connect_path": None,
        "supports_callback": False,
        "supports_redirect": False,
        "fields": [
            {"key": "access_token", "label": "API Auth Token", "type": "password", "required": True, "secret": True},
        ],
        "requirement_note": "Groww Trading API subscription must be active for the client account. Paste the Groww API auth token here; no redirect login is required.",
    },
    "alice blue": {
