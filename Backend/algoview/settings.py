...
AGREEMENT_ADMIN_EMAIL = config('AGREEMENT_ADMIN_EMAIL', default='support@bridgesparkinnovation.com')
...
ANGELONE_SMARTAPI_TIMEOUT_SECONDS = config('ANGELONE_SMARTAPI_TIMEOUT_SECONDS', default=15, cast=int)
...
LIVE_PRICE_CACHE_TIMEOUT_SECONDS = config('LIVE_PRICE_CACHE_TIMEOUT_SECONDS', default=60, cast=int)
LIVE_PRICE_FRESH_SECONDS = config('LIVE_PRICE_FRESH_SECONDS', default=5, cast=int)
SLTP_MAX_PRICE_AGE_SECONDS = config('SLTP_MAX_PRICE_AGE_SECONDS', default=15, cast=int)
SL_TP_WATCHER_SLEEP_SECONDS = config('SL_TP_WATCHER_SLEEP_SECONDS', default=1, cast=int)
MARKET_DATA_UPSTOX_CLIENT_ID = config('MARKET_DATA_UPSTOX_CLIENT_ID', default='', cast=str)
MARKET_DATA_UPSTOX_API_VERSION = config('MARKET_DATA_UPSTOX_API_VERSION', default='3.0', cast=str)
MARKET_DATA_SUBSCRIPTION_REFRESH_SECONDS = config('MARKET_DATA_SUBSCRIPTION_REFRESH_SECONDS', default=30, cast=int)
MARKET_DATA_WEBSOCKET_RECV_TIMEOUT_SECONDS = config('MARKET_DATA_WEBSOCKET_RECV_TIMEOUT_SECONDS', default=45, cast=int)
